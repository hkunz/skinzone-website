...
class PhotoCircularStrip
{
   ...
   private var VISIBLE_PHOTOS:Number = 15;

   public function PhotoCircularStrip(mcHolder:MovieClip, nItems:Number)
   {
      m_mcHolder = mcHolder;
      m_nItems = nItems;
	  initFileStrip();
   ...
   private function initFileStrip():Void
   {
	  ...
	  //var nAdj:Number = 95;
	  var mcNxBtn:MovieClip = m_mcHolder.attachMovie("NextPhotoBtn_MC", "NextPhotoBtn_MC", 2, {_x:105, _y:110});
      var mcPrBtn:MovieClip = m_mcHolder.attachMovie("PrevPhotoBtn_MC", "PrevPhotoBtn_MC", 3, {_x:55, _y:110});
      var mcViewBtn:MovieClip = m_mcHolder.attachMovie("ViewPhotoBtn_MC", "ViewPhotoBtn_MC", 4, {_x:155, _y:110});
   ...
   public function createCircularStrip(nX:Number, nY:Number, nWidth:Number, nHeight:Number):Void
   {
      m_nWidth = nWidth;
      m_nHeight = nHeight;
      m_cArcTweenSet.setPivot(nX, nY);
      m_cArcTweenSet.setRadius(nWidth/2, nHeight/2);
      m_cArcTweenSet.setItemGraphic("BrowseItemRound_MC", true);
      //m_cArcTweenSet.setItemMask("BrowseItemMask_MC");
      //m_cArcTweenSet.setLoadPath(
      //m_cArcTweenSet.setAngleDisappearLimits(
      m_cArcTweenSet.setArcAngleLimits(0, 320); //90 Start at button 180 End at left
	  m_cArcTweenSet.setAngleRemovalTolerance(50); //90 Start at button 180 End at left
      ...
      m_cArcTweenSet.setScaleRange(5, 100);
      m_cArcTweenSet.setAlphaRange(100, 100);
      m_cArcTweenSet.setRotationRange(90, 0);
	  //m_cArcTweenSet.setXRange(100, 200);
	  //m_cArcTweenSet.setYRange(100, 200);
   ...
   public function nextPhoto(fEnableNewItem:Boolean):Void
   {
      ...
      m_pfUpdate.apply(this, [m_cArcTweenSet.getActiveIndex()]);
   }
   ...
   public function shutDown(pfShutDownAftermath:Function, nAnimType:Number):Void
   {
      ...
      setEnabled(false);
      if(nAnimType == undefined) new Tween(m_mcHolder, "_alpha", Strong.easeOut, m_mcHolder._alpha, 0, 1, true);
   }

   public function addUpdateHandler(pfUpdate:Function):Void {m_pfUpdate = pfUpdate; m_cArcTweenSet.addUpdateHandler(pfUpdate);}
   ...
   public function enableContentScaling(fScale:Boolean):Void {m_cArcTweenSet.enableContentScaling(fScale);}
